import Navbar from "../layout/Navbar/navhbar";
...
const SearchPage = ({showSearchPage, setShowSearchpage, changeShelf, shelf, books}) => {
    ...
    return ( 
        ...
        <div className="search-books">
          ...
          <div className="search-books-results">
           ...
           { searchMessage &&  <p className="no-result-message">No books found. Please search for another book!</p> }
